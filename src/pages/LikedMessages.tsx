...
const LikedMessages = () => {
  ...
  const likedMessages = [
    {
      id: 1,
      content: "The Q4 sales report shows exceptional growth with a 35% increase in revenue compared to Q3. The fashion department led with 60% of total sales.",
      author: "AIVA Assistant",
      timestamp: "2024-01-15 14:30",
      context: "Monthly Sales Report Discussion"
    },
    {
      id: 2,
      content: "Great insights on the customer retention strategy! The implementation of automated follow-ups has increased retention by 15%.",
      author: "Team Lead",
    ...
    {
      id: 3,
      content: "The new dashboard design mockups look fantastic. The user experience improvements will definitely enhance client satisfaction.",
      author: "UX Designer",
    ...
    {
      id: 4,
      content: "Successfully completed the data migration with zero downtime. All systems are functioning optimally with improved performance.",
    ...
    {
      id: 5,
      content: "The AI integration is working better than expected. Automated workflows have reduced manual tasks by 40%.",
      author: "Product Manager",
      timestamp: "2024-01-08 13:55",
      context: "AI Implementation Review"
    }
  ];
